...
#ifndef TINYSHOGI_MAX_HISTORY
#define TINYSHOGI_MAX_HISTORY 4096
#endif
#if TINYSHOGI_MAX_HISTORY < 4
#error "TINYSHOGI_MAX_HISTORY must hold a fourfold repetition"
#endif
#define SHOGI_MAX_HISTORY TINYSHOGI_MAX_HISTORY
