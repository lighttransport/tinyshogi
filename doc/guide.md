# TinyShogi user guide

[Back to README](../README.md) · [Live demo](https://lighttransport.github.io/tinyshogi/)

Unless stated otherwise, run commands from the repository root. Examples using
`build/tinyshogi` assume a Meson build; Make writes `build/make/tinyshogi`.

## Contents

- [Overview and rules](#overview-and-rules)
- [Build](#build)
- [USI commands](#usi-commands)
- [Self-play and matches](#self-play-and-matches)
- [External evaluators](#external-evaluators)
- [ARM64 and A64FX](#arm64-and-a64fx)
- [Native NNUE training](#native-nnue-training)
- [Fuzzing](#fuzzing)
...
See [the strength experiment report](strength.md) for exact artifact
...
See [fixture provenance](strength.md#fixtures-and-provenance).
